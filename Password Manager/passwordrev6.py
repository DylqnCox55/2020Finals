        ...
        """)
            ...
            if password=="input":
                ...
                class Generator:      
                    ...
                    def __str__(self):
                        return chr(random.randint(65,90)) * self.capital + chr(random.randint(97,122)) * self.lowercase + chr(random.randint(48,57)) * self.numbers + chr(random.randint(33,42)) * self.symbols

                capital=input("How many capital letters do you want? ")         #input is taken for the number of each type of character
                ...
                password = Generator(capital, lowercase, numbers, symbols)        #the class takes in the inputs and prints random characters
                print(password)       #the generated password is printed
